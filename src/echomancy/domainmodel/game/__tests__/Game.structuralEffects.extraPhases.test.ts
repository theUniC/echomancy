...
test("extra phases are inserted after spell resolves", () => {
...
test("extra phases execute in the declared order", () => {
  const { game, player1, player2 } = createStartedGame()
  advanceToStep(game, Step.FIRST_MAIN)
...
test("priority behavior is preserved during extra phases", () => {
  const { game, player1, player2 } = createStartedGame()
  advanceToStep(game, Step.FIRST_MAIN)
...
test("multiple extra phase effects chain correctly", () => {
  const { game, player1, player2 } = createStartedGame()
  advanceToStep(game, Step.FIRST_MAIN)
...
test("normal turn flow resumes after extra phases complete", () => {
  const { game, player1, player2 } = createStartedGame()
  advanceToStep(game, Step.FIRST_MAIN)
